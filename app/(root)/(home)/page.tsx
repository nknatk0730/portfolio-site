    ...
    <>
      ...
      <section className="flex items-center max-width flex-col-reverse tablet:flex-row mb-10">
        ...
        <div className="tablet:w-2/3 mt-10 tablet:mt-0">
          <div className="flex flex-col gap-3 items-center tablet:items-start max-w-2xl text-center tablet:text-left">
            <p className="px-4 py-2 bg-peach-500 text-grey-600 w-max rounded" data-aos='fade-down'>
              Hello There
            </p>
            <h1 className="text-grey" data-aos='fade-down' data-aos-delay='100'>John Doe welcome you</h1>
            <p className="text-grey-600" data-aos='fade-down' data-aos-delay='200'>
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Deleniti
              id quasi fugiat eum a minus ea aspernatur nemo. Culpa totam
              explicabo odit ipsam pariatur non porro dolore aut voluptas
              voluptatum?
            </p>
          </div>
          <div
      ...
      <section className="max-width section-padding">
        <SectionHeading
          ...
          subtitle='Lorem ipsum dolor sit amet, consectetur adipisicing elit. Expedita dolores molestias illo unde, non laborum error omnis dolor explicabo eos, consectetur voluptate, magnam inventore. Nemo maiores totam culpa sed nostrum!'
        />
        {/* skills */}
